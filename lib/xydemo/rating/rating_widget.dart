...
///三角形等级评分的控件
class TriangleRatingView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return CustomPaint(
      ...
      painter: TrianglePainter(
        ...
        ratingStrokeWidth: ratingStrokeWidth,
        strokeColor: strokeColor,
        ratingStrokeColor: ratingStrokeColor,
        maxRating: maxRating,
      ),
    );
  }
